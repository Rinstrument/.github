...
<!-- ABOUT THE PROJECT -->
## About The 'inirt' Project

[![Product Name Screen Shot][product-screenshot]](https://example.com)

`inirt` can fit a huge variety of Item Resonse Theory models. 

Features and Examples:
* Univariate Item Response Theory
* Multivariate Item Response Theory (exploratory & confirmatory)
* Higher-Order Multivariate Item Response Theory
* Any combination of the models listed above
* Regression modeling of the latent traits in all models
